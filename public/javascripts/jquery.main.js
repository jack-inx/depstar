jQuery(function(){
	...
	initInputs();
	initSameHeight();
	jQuery('.label-text .btn-info').each(function(){
...
browserDetect = {
	matchGroups: [
		[
			{uaString:'nt 6', className:'win-seven'},
			{uaString:'nt 5', className:'win-xp'},
