...
ActiveRecord::Schema.define(:version => 20130118132707) do
  ...
  create_table "carriers_series_lists", :id => false, :force => true do |t|
    t.integer "carrier_id"
  ...
  create_table "order_product_price_types", :force => true do |t|
    t.integer  "order_id"
    t.integer  "product_id"
...
=======
    ...
    t.boolean  "status",       :default => true
    t.integer  "state_id"
>>>>>>> bf292511fb876fb5b8448c3407697a8c4fb961f5
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.datetime "updated_at",                           :null => false
    t.boolean  "status",             :default => true
    t.boolean  "is_affiliate_admin", :default => true
    t.integer  "user_id"
  end
