...
ActiveRecord::Schema.define(:version => 20121213130758) do
  ...
  create_table "other_details", :force => true do |t|
    t.integer  "shipping_detail_id"
    t.integer  "product_id"
  ...
  create_table "products_shipping_details", :id => false, :force => true do |t|
    t.integer "product_id"
    t.integer "shipping_detail_id"
  end
